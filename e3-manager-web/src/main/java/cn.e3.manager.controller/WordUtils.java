...
public class WordUtils {
     ...
     * @param response
     */
    public void getWord(InputStream tempIs,InputStream is, Map<String, Object> params, List<String[]> tableList, String fileName, HttpServletResponse response) throws Exception {
//        File file = new File(path);
//        InputStream is = new FileInputStream(file);

        CustomXWPFDocument doc = new CustomXWPFDocument(is);
        CustomXWPFDocument doc2 =new CustomXWPFDocument(tempIs);
        this.replaceInPara(doc, params);    //替换文本里面的变量
        this.replaceInTable(doc, params, tableList); //替换表格里面的变量
        //https://www.cnblogs.com/homeSicker/p/7728854.html
        this.setStyle(doc2,doc,params);//设置样式
